...
export const getTasksTC = createAppAsyncThunk<{ todolistId: string, tasks: TasksTypeApi[] }, { todolistId: string }>(
...
export const addTasksTC = createAppAsyncThunk<{ todolistId: string, title: string, task: TasksTypeApi }, {
    todolistId: string,
    title: string
}>(
...
export const TaskThunks = {getTasksTC, addTasksTC}
